...
#
# Generated by export_simulation on Thu Apr 04 00:41:19 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './hdmi_block.sh' script.

./hdmi_block.sh -reset_run
...
./hdmi_block.sh -noclean_files

For more information on the script, please type './hdmi_block.sh -help'.
