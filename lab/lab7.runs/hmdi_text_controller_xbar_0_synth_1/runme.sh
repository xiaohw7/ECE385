...
HD_PWD='C:/Users/user/OneDrive/Documents/ECE385/ECE385/lab7/lab7.runs/hmdi_text_controller_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hmdi_text_controller_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hmdi_text_controller_xbar_0.tcl
