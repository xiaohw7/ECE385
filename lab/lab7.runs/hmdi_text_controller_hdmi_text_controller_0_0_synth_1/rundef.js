...
ISEStep( "vivado",
         "-log hmdi_text_controller_hdmi_text_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hmdi_text_controller_hdmi_text_controller_0_0.tcl" );
