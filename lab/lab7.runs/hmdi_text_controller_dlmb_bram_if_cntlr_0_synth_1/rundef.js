...
ISEStep( "vivado",
         "-log hmdi_text_controller_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hmdi_text_controller_dlmb_bram_if_cntlr_0.tcl" );
