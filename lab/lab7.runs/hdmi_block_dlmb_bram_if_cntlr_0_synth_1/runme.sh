...
HD_PWD='C:/Users/user/OneDrive/Documents/ECE385/ECE385/lab7/lab7.runs/hdmi_block_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_block_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_block_dlmb_bram_if_cntlr_0.tcl
